              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                   ...
                   <form class="form-horizontal form-label-left" enctype='multipart/form-data' method="post" action="{{route('insertemployeeDetails')}}" id="addemployee" >
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  id='name' name='name' class="form-control col-md-7 col-xs-12 parsley-success"  onkeypress="hidedivname()" required>
                        </div>
                          @if($errors->has('name'))
                      ...
                      <div class="form-group">
                        <label for="email" class="control-label col-md-3 col-sm-3 col-xs-12" >Personal Email
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" class="form-control col-md-7 col-xs-12 parsley-success" id='email' name='email' onkeypress="hidedivemail()">
                        </div>
                         @if($errors->has('email'))
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea class="form-control col-md-7 col-xs-12"  rows="4" cols="50" id='address' name='address' onkeypress="hidedivaddress()" required></textarea>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" class="form-control col-md-7 col-xs-12" id='phone_number' name='phone_number' onkeypress="hidedivphone_number()" required >
                        </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" class="form-control col-md-7 col-xs-12" id='alternative_phone_number' name='alternative_phone_number' onkeypress="hidedivalternative_phone_number()">
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id='date_of_birth' name='date_of_birth'  class="datepicker form-control col-md-7 col-xs-12 parsley-success" onkeypress="hidedivdate_of_birth()" onclick="hidedivdate_of_birth()" required><ul class="parsley-errors-list" ></ul>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id='date_of_joining' name='date_of_joining' class="datepicker form-control col-md-7 col-xs-12 parsley-success" required data-parsley-id="16" onkeypress="hidedivdate_of_joining()" onclick="hidedivdate_of_joining()"><ul class="parsley-errors-list" id="parsley-id-16"></ul>
                        </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id='company_email' name='company_email' class="form-control col-md-7 col-xs-12 parsley-success" data-parsley-id="5"  onkeypress="hidedivcompany_email()"><ul class="parsley-errors-list" id="parsley-id-5"></ul>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id='designation' name='designation' class="form-control col-md-7 col-xs-12 parsley-success" data-parsley-id="5"><ul class="parsley-errors-list" id="parsley-id-5"></ul>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  id='salary' name='salary' class="form-control col-md-7 col-xs-12 parsley-success" data-parsley-id="5" onkeypress="hidedivsalary()"><ul class="parsley-errors-list" id="parsley-id-5"></ul>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  id='particle_id' name='particle_id' class="form-control col-md-7 col-xs-12 parsley-success"  data-parsley-id="5"><ul class="parsley-errors-list" id="parsley-id-5"></ul>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  id='access_token' name='access_token' class="form-control col-md-7 col-xs-12 parsley-success" data-parsley-id="5"><ul class="parsley-errors-list" id="parsley-id-5"></ul>
                        </div>
                      </div>
